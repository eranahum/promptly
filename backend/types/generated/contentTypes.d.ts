...
export interface ApiResponseResponse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'ChatGPT API responses';
...
export interface ApiTextText extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User input texts for processing';
    displayName: 'Text';
    pluralName: 'texts';
    singularName: 'text';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    type: Schema.Attribute.Enumeration<['ask', 'suggest']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWordWord extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generated word suggestions';
    displayName: 'Word';
    pluralName: 'words';
    singularName: 'word';
  };
